...
<div id="product-informations" class="panel product-tab">
    ...
    <div class="col-lg-9">
      <div class="checkbox">
        <label for="tassa_di_consumo">
          <input type="checkbox" name="tassa_di_consumo" id="tassa_di_consumo" value="1" {if $product->tassa_di_consumo}checked="checked"{/if} >
          {l s='Prodotto soggetto a tassa di consumo'}</label>
      </div>
    </div>
  </div>
