...
<div id="product-combinations" class="panel product-tab">
	...
	<div id="add_new_combination" class="panel" style="display: none;">
		...
		<div class="form-group">
      <div class="col-lg-1"><span class="pull-right">{include file="controllers/products/multishop/checkbox.tpl" field="tassa_di_consumo_comb" type="default"}</span></div>
      <label class="control-label col-lg-2" for="attribute_tassa_di_consumo_comb">
        {l s='Tassa'}
      </label>
      <div class="col-lg-9">
        <p class="checkbox">
        <label for="attribute_tassa_di_consumo_comb">
          <input type="checkbox" name="attribute_tassa_di_consumo_comb" id="attribute_tassa_di_consumo_comb" value="1" />
          {l s='prodotto soggetto a tassa'}
        </label>
        </p>
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-lg-3" for="attribute_ml_flacone_comb">
        {l s='Formato ml'}
      </label>
      <div class="col-lg-9">
        <label for="attribute_ml_flacone_comb">
          <input type="text" name="attribute_ml_flacone_comb" id="attribute_ml_flacone_comb" value="0.00" />
          {l s='indicare il formato del flacone in ml'}
        </label>
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-lg-3" for="attribute_ml_nicotina_comb">
        {l s='% ml di nicotina'}
      </label>
      <div class="col-lg-9">
        <label for="attribute_ml_nicotina_comb">
          <input type="text" name="attribute_ml_nicotina_comb" id="attribute_ml_nicotina_comb" value="0.00" />
          {l s='indicare la quantita di nicotina in mg/ml'}
        </label>
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-lg-3" for="attribute_codice_articolo">
        <span class="label-tooltip" data-toggle="tooltip"
          title="{l s='Special characters allowed:'} .-_#">
          {l s='Codice articolo'}
        </span>
      ...
      <div class="col-lg-5">
        <input type="text" id="attribute_codice_articolo" name="attribute_codice_articolo" value="" />
      </div>
    </div>
