							...
							<div class="panel panel-total">
								<div class="table-responsive">
									<table class="table">
										...
										<tr id="total_taxes">
                      <td class="text-right">{l s='Tassa di consumo'}</td>
                      <td class="amount text-right nowrap" >{displayPrice price=($order->total_tassa_di_consumo) currency=$currency->id}</td>
                      <td class="partial_refund_fields current-edit" style="display:none;"></td>
                    </tr>
										{if ($order->getTaxCalculationMethod() == $smarty.const.PS_TAX_EXC)}
			 							<tr id="total_taxes">
			 								<td class="text-right">{l s='Taxes'}</td>
			 								<td class="amount text-right nowrap" >{displayPrice price=($order->total_paid_tax_incl-$order->total_paid_tax_excl-$order->total_tassa_di_consumo) currency=$currency->id}</td>
			 								<td class="partial_refund_fields current-edit" style="display:none;"></td>
			 							</tr>
			 							{/if}
