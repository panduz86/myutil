	...
	protected function assignAttributesGroups()
	{
		...
		if (is_array($attributes_groups) && $attributes_groups) {
			...
			foreach ($attributes_groups as $k => $row) {
				...
				$combinations[$row['id_product_attribute']]['tassa_di_consumo'] = Product::getTassaDiConsumo((int)$this->product->id, $row['id_product_attribute'],(int)$row['quantity'], $this->context->cart->id_address_invoice);
			}
